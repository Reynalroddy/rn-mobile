...
const ProfileStack = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    const currentRoute = currentRouteIndex
      ? routes[routes.length - 1].state?.routeNames[currentRouteIndex]
      : '';

    const unsubscribe = navigation.addListener('focus', () => {
      // Reset the stack to "MyProfile" if its not my profile.
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        ...
        component={HomeStack}
        options={{
          drawerIcon: color => <HomeIcon size={22} color={'black'} />,
        }}
      />
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: color => <ShoppingCartIcon size={22} color={'#333'} />,
        }}
      />
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: color => <UserIcon size={22} color={'black'} />,
