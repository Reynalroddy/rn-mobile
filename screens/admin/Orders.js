...
const AdminOrders = () => {
  ...
  const { loading, orders } = useGetOrders(isFocused,true,token);
 ...
 <>
      ...
      {loading ? (
         <ActivityIndicator size={'large'} color='black'/>
          ...
          <Text className='font-bold text-black text-lg'>ALL ORDERS</Text>
          </View>
...
<Text className='text-black' >ordered:{item.createdAt.split('T')[0]}</Text>
                  </View>
