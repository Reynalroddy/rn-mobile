      ...
      {loading ? (
        ...
        <>
          <View className="flex-row  items-center justify-between pr-3">
            <TouchableOpacity
              className="bg-yellow-600 h-9 w-9 rounded-full flex-row items-center justify-center mt-7 mb-2 ml-4"
          ...
          <ScrollView
            ...
            {orders.length > 0 ? (
              orders.map((item, index) => (
                ...
                <View
                  className="p-4 rounded-md border-gray-500 bg-white my-2 mx-4"
                  key={index}>
                  <Text className="text-black">
                    Amount: N {item.totalAmount}
                  </Text>
